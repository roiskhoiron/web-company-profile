				...
				<div class="search">
					<div class="search_content d-flex flex-column align-items-center justify-content-center">
							...
							<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
								...
								<g>
									<g>
										...
										c4.898,4.898,11.333,7.349,17.766,7.349c6.435,0,12.868-2.45,17.767-7.349l0,0C91.266,44.235,91.266,28.293,81.47,18.495zM77.831,50.395c-7.79,7.791-20.466,7.791-28.256,0c-7.79-7.792-7.79-20.469,0-28.261c3.896-3.896,9.011-5.843,14.128-5.843
						...
						<div class="card-header">
								<a onclick="addPortofolio()" href="#!"><i class="fas fa-plus" style="color:white;"></i></a>
						</div>
