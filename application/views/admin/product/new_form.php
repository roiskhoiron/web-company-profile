					...
					<div class="card-body">
						...
						<form action="<?php echo site_url('admin/products/add') ?>" method="post" enctype="multipart/form-data" >
							<div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('sender') ? 'is-invalid':'' ?>"
                                type="text" name="sender" placeholder="Product sender" />
							...
							<div class="form-group">
                                ...
                                type="text" name="link" min="0" placeholder="Product link" />
								<div class="invalid-feedback">
